...
How many species have at least one missing entry?
...
::: callout-important
8 out of 9 species have missing or incorrect data.
:::
...
In one specific case, the species reported in both the CAMDA and antibiogram datasets is incorrect: SRR2101499 was annotated as *Staphylococcus aureus*, but it has been previously reported to be misassigned and actually corresponds to *Mycobacterium tuberculosis*.

Based on the information obtained from public datasets, we have decided to remove SRA IDs SRR2101499, ERR1218771, and SRR5386043, as they correspond to species that are not relevant or appropriate for the scope of this study and are considered sources of noise in the identification of antimicrobial resistance genes.
